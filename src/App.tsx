    ...
    <div className="not-loaded">
      <div className='content'>
        ...
        <p style={{
          ...
          borderRadius: "20px",
          padding: "10px"}}>
          Красотка, желаю тебе мощного головокружения от крутых эмоций, душевного спокойствия и железного здоровья.
          Желаю хренава тучу счастья, денег, везения и моментов, чтобы всегда с кайфом ходила.
          Счастья, благополучия, верных друзей и безпроблемного будущего и здоровья близким. Обнял, приподнял, покружил и поставил)
        </p>
      </div>
        <Player/>
